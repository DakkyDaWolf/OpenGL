...
namespace Library
{
	...
	SHADER_VARIABLE_DEFINITION(ShadowcastedDirectionalEffect, WorldViewProjection)
	SHADER_VARIABLE_DEFINITION(ShadowcastedDirectionalEffect, World)
	SHADER_VARIABLE_DEFINITION(ShadowcastedDirectionalEffect, AmbientColor)
	SHADER_VARIABLE_DEFINITION(ShadowcastedDirectionalEffect, LightColor)
	SHADER_VARIABLE_DEFINITION(ShadowcastedDirectionalEffect, LightLookDirection)
	SHADER_VARIABLE_DEFINITION(ShadowcastedDirectionalEffect, CameraPosition)
	SHADER_VARIABLE_DEFINITION(ShadowcastedDirectionalEffect, SpecularColor)
	SHADER_VARIABLE_DEFINITION(ShadowcastedDirectionalEffect, SpecularPower)
	SHADER_VARIABLE_DEFINITION(ShadowcastedDirectionalEffect, FogColor)
	SHADER_VARIABLE_DEFINITION(ShadowcastedDirectionalEffect, FogStart)
	SHADER_VARIABLE_DEFINITION(ShadowcastedDirectionalEffect, FogRange)
	SHADER_VARIABLE_DEFINITION(ShadowcastedDirectionalEffect, LightPosition)
	SHADER_VARIABLE_DEFINITION(ShadowcastedDirectionalEffect, LightInnerAngle)
	SHADER_VARIABLE_DEFINITION(ShadowcastedDirectionalEffect, LightOuterAngle)
	SHADER_VARIABLE_DEFINITION(ShadowcastedDirectionalEffect, LightFalloffRange)


	void ShadowcastedDirectionalEffect::Initialize(GLuint vertexArrayObject)
	{
